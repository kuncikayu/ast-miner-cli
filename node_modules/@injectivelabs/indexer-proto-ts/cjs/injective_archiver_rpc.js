...
exports.HistoricalBalance = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        for (const v of message.dv) {
            exports.HistoricalDetailedBalance.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.dv.push(exports.HistoricalDetailedBalance.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            dv: Array.isArray(object === null || object === void 0 ? void 0 : object.dv) ? object.dv.map((e) => exports.HistoricalDetailedBalance.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.dv) {
            obj.dv = message.dv.map((e) => e ? exports.HistoricalDetailedBalance.toJSON(e) : undefined);
        }
        else {
            obj.dv = [];
        }
    ...
    fromPartial(object) {
        ...
        message.dv = ((_c = object.dv) === null || _c === void 0 ? void 0 : _c.map((e) => exports.HistoricalDetailedBalance.fromPartial(e))) || [];
        return message;
    },
};
...
exports.HistoricalDetailedBalance = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.spot !== 0) {
    ...
    create(base) {
        return exports.HistoricalDetailedBalance.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseHistoricalDetailedBalance();
        message.spot = (_a = object.spot) !== null && _a !== void 0 ? _a : 0;
        message.perp = (_b = object.perp) !== null && _b !== void 0 ? _b : 0;
        return message;
    },
};
