...
exports.Operator = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.subaccountId !== "") {
            writer.uint32(58).string(message.subaccountId);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.percentage = (_f = object.percentage) !== null && _f !== void 0 ? _f : "";
        message.subaccountId = (_g = object.subaccountId) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
