...
exports.TxData = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.ethereumTxHashHex !== "") {
            writer.uint32(122).string(message.ethereumTxHashHex);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            signatures: Array.isArray(object === null || object === void 0 ? void 0 : object.signatures) ? object.signatures.map((e) => exports.Signature.fromJSON(e)) : [],
            blockUnixTimestamp: isSet(object.blockUnixTimestamp) ? String(object.blockUnixTimestamp) : "0",
            ethereumTxHashHex: isSet(object.ethereumTxHashHex) ? String(object.ethereumTxHashHex) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.blockUnixTimestamp !== undefined && (obj.blockUnixTimestamp = message.blockUnixTimestamp);
        message.ethereumTxHashHex !== undefined && (obj.ethereumTxHashHex = message.ethereumTxHashHex);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.ethereumTxHashHex = (_q = object.ethereumTxHashHex) !== null && _q !== void 0 ? _q : "";
        return message;
    },
};
