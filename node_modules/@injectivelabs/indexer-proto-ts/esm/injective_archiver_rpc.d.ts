...
export declare const HistoricalDetailedBalance: {
    encode(message: HistoricalDetailedBalance, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): HistoricalDetailedBalance;
    fromJSON(object: any): HistoricalDetailedBalance;
    toJSON(message: HistoricalDetailedBalance): unknown;
    create(base?: DeepPartial<HistoricalDetailedBalance>): HistoricalDetailedBalance;
    fromPartial(object: DeepPartial<HistoricalDetailedBalance>): HistoricalDetailedBalance;
};
