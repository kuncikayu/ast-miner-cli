...
export declare const PointsCreateAdminCorrectionsBatchRequest: {
    encode(message: PointsCreateAdminCorrectionsBatchRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PointsCreateAdminCorrectionsBatchRequest;
    fromJSON(object: any): PointsCreateAdminCorrectionsBatchRequest;
    toJSON(message: PointsCreateAdminCorrectionsBatchRequest): unknown;
    create(base?: DeepPartial<PointsCreateAdminCorrectionsBatchRequest>): PointsCreateAdminCorrectionsBatchRequest;
    fromPartial(object: DeepPartial<PointsCreateAdminCorrectionsBatchRequest>): PointsCreateAdminCorrectionsBatchRequest;
};
...
export declare const PointsCaptureSeasonOneSnapshotAndBonusRequest: {
    encode(_: PointsCaptureSeasonOneSnapshotAndBonusRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PointsCaptureSeasonOneSnapshotAndBonusRequest;
    fromJSON(_: any): PointsCaptureSeasonOneSnapshotAndBonusRequest;
    toJSON(_: PointsCaptureSeasonOneSnapshotAndBonusRequest): unknown;
    create(base?: DeepPartial<PointsCaptureSeasonOneSnapshotAndBonusRequest>): PointsCaptureSeasonOneSnapshotAndBonusRequest;
    fromPartial(_: DeepPartial<PointsCaptureSeasonOneSnapshotAndBonusRequest>): PointsCaptureSeasonOneSnapshotAndBonusRequest;
};
export declare const PointsCaptureSeasonOneSnapshotAndBonusResponse: {
    encode(message: PointsCaptureSeasonOneSnapshotAndBonusResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PointsCaptureSeasonOneSnapshotAndBonusResponse;
    fromJSON(object: any): PointsCaptureSeasonOneSnapshotAndBonusResponse;
    toJSON(message: PointsCaptureSeasonOneSnapshotAndBonusResponse): unknown;
    create(base?: DeepPartial<PointsCaptureSeasonOneSnapshotAndBonusResponse>): PointsCaptureSeasonOneSnapshotAndBonusResponse;
    fromPartial(object: DeepPartial<PointsCaptureSeasonOneSnapshotAndBonusResponse>): PointsCaptureSeasonOneSnapshotAndBonusResponse;
};
export declare const PointsRecomputeDailyPointsSnapshotsRequest: {
    encode(_: PointsRecomputeDailyPointsSnapshotsRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PointsRecomputeDailyPointsSnapshotsRequest;
    fromJSON(_: any): PointsRecomputeDailyPointsSnapshotsRequest;
    toJSON(_: PointsRecomputeDailyPointsSnapshotsRequest): unknown;
    create(base?: DeepPartial<PointsRecomputeDailyPointsSnapshotsRequest>): PointsRecomputeDailyPointsSnapshotsRequest;
    fromPartial(_: DeepPartial<PointsRecomputeDailyPointsSnapshotsRequest>): PointsRecomputeDailyPointsSnapshotsRequest;
};
export declare const PointsRecomputeDailyPointsSnapshotsResponse: {
    encode(_: PointsRecomputeDailyPointsSnapshotsResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): PointsRecomputeDailyPointsSnapshotsResponse;
    fromJSON(_: any): PointsRecomputeDailyPointsSnapshotsResponse;
    toJSON(_: PointsRecomputeDailyPointsSnapshotsResponse): unknown;
    create(base?: DeepPartial<PointsRecomputeDailyPointsSnapshotsResponse>): PointsRecomputeDailyPointsSnapshotsResponse;
    fromPartial(_: DeepPartial<PointsRecomputeDailyPointsSnapshotsResponse>): PointsRecomputeDailyPointsSnapshotsResponse;
};
...
export interface PointsSvc {
    ...
    /**
     * Admin-only endpoint to create a new points corrections (sharing same type,
     * label, effective date).
     */
    PointsCreateAdminCorrectionsBatch(request: DeepPartial<PointsCreateAdminCorrectionsBatchRequest>, metadata?: grpc.Metadata): Promise<AdminPointsCorrectionCollection>;
    ...
    /**
     * Admin-only endpoint to capture current points totals as snapshot for S1 and
     * calculate bonus.
     */
    PointsCaptureSeasonOneSnapshotAndBonus(request: DeepPartial<PointsCaptureSeasonOneSnapshotAndBonusRequest>, metadata?: grpc.Metadata): Promise<PointsCaptureSeasonOneSnapshotAndBonusResponse>;
    /**
     * Admin-only endpoint to recompute daily points snapshots within (last 6
     * months).
     */
    PointsRecomputeDailyPointsSnapshots(request: DeepPartial<PointsRecomputeDailyPointsSnapshotsRequest>, metadata?: grpc.Metadata): Promise<PointsRecomputeDailyPointsSnapshotsResponse>;
}
...
export declare const PointsSvcPointsCreateAdminCorrectionsBatchDesc: UnaryMethodDefinitionish;
...
export declare const PointsSvcPointsCaptureSeasonOneSnapshotAndBonusDesc: UnaryMethodDefinitionish;
export declare const PointsSvcPointsRecomputeDailyPointsSnapshotsDesc: UnaryMethodDefinitionish;
