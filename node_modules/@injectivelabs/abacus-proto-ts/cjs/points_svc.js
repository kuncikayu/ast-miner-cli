...
exports.PointsLatestForAccountResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.pointsSeason1 !== 0) {
            writer.uint32(49).double(message.pointsSeason1);
        }
        if (message.pointsBonus !== 0) {
            writer.uint32(57).double(message.pointsBonus);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            pointsSeason1: isSet(object.pointsSeason1) ? Number(object.pointsSeason1) : 0,
            pointsBonus: isSet(object.pointsBonus) ? Number(object.pointsBonus) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.pointsSeason1 !== undefined && (obj.pointsSeason1 = message.pointsSeason1);
        message.pointsBonus !== undefined && (obj.pointsBonus = message.pointsBonus);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.pointsSeason1 = (_f = object.pointsSeason1) !== null && _f !== void 0 ? _f : 0;
        message.pointsBonus = (_g = object.pointsBonus) !== null && _g !== void 0 ? _g : 0;
        return message;
    },
};
...
exports.LeaderboardPointsRow = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.league !== "") {
            writer.uint32(42).string(message.league);
        }
        return writer;
    },
    decode(input, length) {
...
function createBasePointsCreateAdminCorrectionsBatchRequest() {
    return { accountAddresses: [], correctionType: "", values: [], label: "", effectiveFrom: "0" };
}
exports.PointsCreateAdminCorrectionsBatchRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        for (const v of message.accountAddresses) {
            writer.uint32(10).string(v);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePointsCreateAdminCorrectionsBatchRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            accountAddresses: Array.isArray(object === null || object === void 0 ? void 0 : object.accountAddresses)
                ...
                : [],
            correctionType: isSet(object.correctionType) ? String(object.correctionType) : "",
            values: Array.isArray(object === null || object === void 0 ? void 0 : object.values) ? object.values.map((e) => Number(e)) : [],
            label: isSet(object.label) ? String(object.label) : "",
            effectiveFrom: isSet(object.effectiveFrom) ? String(object.effectiveFrom) : "0",
        };
    },
    ...
    create(base) {
        return exports.PointsCreateAdminCorrectionsBatchRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBasePointsCreateAdminCorrectionsBatchRequest();
...
function createBasePointsCaptureSeasonOneSnapshotAndBonusRequest() {
    return {};
}
exports.PointsCaptureSeasonOneSnapshotAndBonusRequest = {
    encode(_, writer = minimal_js_1.default.Writer.create()) {
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePointsCaptureSeasonOneSnapshotAndBonusRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    create(base) {
        return exports.PointsCaptureSeasonOneSnapshotAndBonusRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBasePointsCaptureSeasonOneSnapshotAndBonusRequest();
        return message;
...
function createBasePointsCaptureSeasonOneSnapshotAndBonusResponse() {
    return { accountsProcessed: "0" };
}
exports.PointsCaptureSeasonOneSnapshotAndBonusResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.accountsProcessed !== "0") {
            writer.uint32(8).sint64(message.accountsProcessed);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePointsCaptureSeasonOneSnapshotAndBonusResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.accountsProcessed = longToString(reader.sint64());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return { accountsProcessed: isSet(object.accountsProcessed) ? String(object.accountsProcessed) : "0" };
    },
    toJSON(message) {
        const obj = {};
        message.accountsProcessed !== undefined && (obj.accountsProcessed = message.accountsProcessed);
        return obj;
    },
    create(base) {
        return exports.PointsCaptureSeasonOneSnapshotAndBonusResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBasePointsCaptureSeasonOneSnapshotAndBonusResponse();
        message.accountsProcessed = (_a = object.accountsProcessed) !== null && _a !== void 0 ? _a : "0";
        return message;
    },
};
function createBasePointsRecomputeDailyPointsSnapshotsRequest() {
    return {};
}
exports.PointsRecomputeDailyPointsSnapshotsRequest = {
    encode(_, writer = minimal_js_1.default.Writer.create()) {
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePointsRecomputeDailyPointsSnapshotsRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    create(base) {
        return exports.PointsRecomputeDailyPointsSnapshotsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBasePointsRecomputeDailyPointsSnapshotsRequest();
        return message;
...
function createBasePointsRecomputeDailyPointsSnapshotsResponse() {
    return {};
}
exports.PointsRecomputeDailyPointsSnapshotsResponse = {
    encode(_, writer = minimal_js_1.default.Writer.create()) {
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePointsRecomputeDailyPointsSnapshotsResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    create(base) {
        return exports.PointsRecomputeDailyPointsSnapshotsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBasePointsRecomputeDailyPointsSnapshotsResponse();
        return message;
...
class PointsSvcClientImpl {
    constructor(rpc) {
        ...
        this.PointsCreateAdminCorrectionsBatch = this.PointsCreateAdminCorrectionsBatch.bind(this);
        ...
        this.PointsCaptureSeasonOneSnapshotAndBonus = this.PointsCaptureSeasonOneSnapshotAndBonus.bind(this);
        this.PointsRecomputeDailyPointsSnapshots = this.PointsRecomputeDailyPointsSnapshots.bind(this);
    }
    ...
    PointsCreateAdminCorrectionsBatch(request, metadata) {
        return this.rpc.unary(exports.PointsSvcPointsCreateAdminCorrectionsBatchDesc, exports.PointsCreateAdminCorrectionsBatchRequest.fromPartial(request), metadata);
    }
    ...
    PointsCaptureSeasonOneSnapshotAndBonus(request, metadata) {
        return this.rpc.unary(exports.PointsSvcPointsCaptureSeasonOneSnapshotAndBonusDesc, exports.PointsCaptureSeasonOneSnapshotAndBonusRequest.fromPartial(request), metadata);
    }
    PointsRecomputeDailyPointsSnapshots(request, metadata) {
        return this.rpc.unary(exports.PointsSvcPointsRecomputeDailyPointsSnapshotsDesc, exports.PointsRecomputeDailyPointsSnapshotsRequest.fromPartial(request), metadata);
    }
}
...
exports.PointsSvcPointsCreateAdminCorrectionsBatchDesc = {
    methodName: "PointsCreateAdminCorrectionsBatch",
    service: exports.PointsSvcDesc,
    requestStream: false,
    responseStream: false,
    requestType: {
        serializeBinary() {
            return exports.PointsCreateAdminCorrectionsBatchRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
...
exports.PointsSvcPointsCaptureSeasonOneSnapshotAndBonusDesc = {
    methodName: "PointsCaptureSeasonOneSnapshotAndBonus",
    service: exports.PointsSvcDesc,
    requestStream: false,
    responseStream: false,
    requestType: {
        serializeBinary() {
            return exports.PointsCaptureSeasonOneSnapshotAndBonusRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.PointsCaptureSeasonOneSnapshotAndBonusResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
...
exports.PointsSvcPointsRecomputeDailyPointsSnapshotsDesc = {
    methodName: "PointsRecomputeDailyPointsSnapshots",
    service: exports.PointsSvcDesc,
    requestStream: false,
    responseStream: false,
    requestType: {
        serializeBinary() {
            return exports.PointsRecomputeDailyPointsSnapshotsRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.PointsRecomputeDailyPointsSnapshotsResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
